...
<body>
  ...
  <nav id="header" class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container">
      <a class="navbar-brand" href="./agzdesign">
        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="150px" version="1.1" style="
              shape-rendering: geometricPrecision;
              text-rendering: geometricPrecision;
              image-rendering: optimizeQuality;
              fill-rule: evenodd;
              clip-rule: evenodd;
            " viewBox="0 0 120.25 30.37" xmlns:xlink="http://www.w3.org/1999/xlink">
          <defs>
          ...
          <g id="Layer_x0020_1">
            ...
            <path class="fil01b"
              d="M103.49 8.22c-3.44,0.82 -6.42,4.18 -5.39,8.61 0.77,3.31 4.25,6.26 8.55,5.31 3.29,-0.73 6.37,-4.24 5.35,-8.55 -0.78,-3.31 -4.16,-6.4 -8.51,-5.36zm0.51 1.45c-7.32,1.44 -5.15,12.45 2.12,11 2.68,-0.53 5.07,-3.16 4.44,-6.53 -0.52,-2.74 -3.22,-5.13 -6.56,-4.47z" />
            <path class="fil0a"
      ...
      <div class="main-nav collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          ...
          <a class="nav-item nav-link" href="./graphic-design/">
            Graphic Design</a>
          <a class="nav-item nav-link" href="./web-design/"> Web Design</a>
          <a class="nav-item nav-link" href="./profil/" target="_blank">
            Author</a>
        </div>
      </div>
    </div>
  ...
  <!-- Modals -->
  <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labElledby="PesanSekarang" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="pesan.php" method="post">
            <div class="produkDipilih">
              <div class="picDipilih" style="display: inline-block;"></div>
              <h5 class="namaTerpilih"></h5>
            </div>
            <div class="row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control email" placeholder="emailmu@mail.me" name="email" value=""
                    required />
                </div>
              </div>
              <div class="col">
                <div class="form-group">
                  <label for="no-hp">No HP / Whatsapp <font color="red">*</font> :</label>
                  <input type="number" class="form-control nohp" placeholder="+6280xxxx" name="nohp" id="no-hp" value=""
                    required />
                </div>
              </div>
            </div>
            <div class="form-group">
              <label for="name">Nama <font color="red">*</font> :
                <span class="terdaftar"></span></label>
              <input type="text" class="form-control namaclient" placeholder="Agus" name="nama" id="name" value=""
                required />
            </div>
            <div class="form-group">
              <label for="alamat"> Alamat :</label>
              <input type="text" name="alamat" id="alamat" class="form-control alamat" value="" />
            </div>
            <div class="form-group">
              <label for="pesan">Pesan Anda :</label>
              <textarea name="pesan" class="form-control textpesan" id="textpesan"></textarea>
            </div>
            <span style="display: block;"><small><i>*Tarif tercantum adalah tarif termurah, tarif disesuaikan
                  dengan tingkan kesulitan dan waktu pengerjaan</i></small></span>
            <div style="text-align: right;">
              <input type="hidden" name="idClient" class="idClient" value="" />
              <input type="hidden" name="idProduk" class="idProduk" value="" />
              <input type="submit" value="Pesan" name="kirim" class="btn btn1" />
            </div>
          </form>
        </div>
      </div>
